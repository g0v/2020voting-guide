...
def write_result_to_db(input_path):
    with open(input_path) as fp:
        politics_list = json.load(fp)
    Politics.drop_table()
    Politics.create_table()
    Politics.insert_many(politics_list).execute()
...
if __name__ == "__main__":
    ...
    write_result_to_db(POLITICS_FILE_NAME)
